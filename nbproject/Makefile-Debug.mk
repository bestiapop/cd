...
${OBJECTDIR}/algorithm/huffmanlzfile.o: algorithm/huffmanlzfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/algorithm
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/algorithm/huffmanlzfile.o algorithm/huffmanlzfile.cpp
...
${OBJECTDIR}/controllers/BitInHuffman.o: controllers/BitInHuffman.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controllers/BitInHuffman.o controllers/BitInHuffman.cpp
...
${OBJECTDIR}/controllers/Utils.o: controllers/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/controllers
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/controllers/Utils.o controllers/Utils.cpp
...
${OBJECTDIR}/interfaces/Factory.o: interfaces/Factory.cpp 
	${MKDIR} -p ${OBJECTDIR}/interfaces
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/Factory.o interfaces/Factory.cpp
