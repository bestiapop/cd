...
${OBJECTDIR}/method/Method.o: method/Method.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method/Method.o method/Method.cpp

${OBJECTDIR}/method/byteMethod.o: method/byteMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/method
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method/byteMethod.o method/byteMethod.cpp

${OBJECTDIR}/method/huffmanMethod.o: method/huffmanMethod.cpp 
	${MKDIR} -p ${OBJECTDIR}/method
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method/huffmanMethod.o method/huffmanMethod.cpp
